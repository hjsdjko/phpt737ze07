<template>
<div class="content" :style='{"padding":"0px 20px 20px","fontSize":"16px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230802/ca0e16da47cd412f8c3070362699771f.jpg) no-repeat center bottom / cover","display":"flex"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"width":"100%","margin":"30px auto 40px","fontSize":"28px","color":"rgb(51, 51, 51)","textAlign":"center","fontWeight":"bold"}'>欢迎使用 {{this.$project.projectName}}</div>
...
<style lang="scss" scoped>
	...
	// 日历
	.calendar td .text {
				border: 1px solid rgba(126, 96, 16, .1);
				border-radius: 0px;
