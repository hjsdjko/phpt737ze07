...
import center from '@/views/center'
    ...
    import discusssheyingqicai from '@/views/modules/discusssheyingqicai/list'
    import sheyingqicai from '@/views/modules/sheyingqicai/list'
...
export const routes = [{
	...
	path: '/discusssheyingqicai',
        name: '摄影器材评论',
        component: discusssheyingqicai
      }
      ,{
	path: '/sheyingqicai',
        name: '摄影器材',
        component: sheyingqicai
      }
      ,{
	path: '/zaixiankecheng',
        name: '在线课程',
