...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
				...
				background: linear-gradient(180deg, rgba(160,8,8,1) 0%, rgba(222,40,40,1) 50%, rgba(160,8,8,1) 100%) !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other /deep/ .el-submenu__title {
				...
				clip-path: polygon(0% 0%, 95% 0, 100% 50%, 88% 100%, 0% 100%) !important;
				color: #fff !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
				padding: 0 0px;
				color: #333;
				background: linear-gradient(180deg, rgba(209,173,78,.1) 0%, rgba(126,96,16,.1) 100%);
				width: 80%;
