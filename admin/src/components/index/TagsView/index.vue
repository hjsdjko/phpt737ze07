<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"6px 30px","boxShadow":"none","margin":"0 auto","borderColor":"rgba(126, 96, 16, .2)","overflow":"hidden","background":"#fff","borderWidth":"0 0 1px","width":"calc(100% - 0px)","fontSize":"16px","borderStyle":"solid","height":"auto"}'>
